...
declare goabi0cc i64 @abi0_decl(i64, i64)
...
define goabi0cc i64 @abi0_call(i64 %a, i64 %b) {
entry:
  %ret = call goabi0cc i64 @abi0_decl(i64 %a, i64 %b)
  ret i64 %ret
}

; CHECK: declare gocc { i64, [2 x i64] } @tuple_decl(i64, i64, i64) #[[ATTR:[0-9]+]]
; CHECK: declare goabi0cc i64 @abi0_decl(i64, i64)
...
; CHECK: define goabi0cc i64 @abi0_call(i64 %a, i64 %b) {
; CHECK: %ret = call goabi0cc i64 @abi0_decl(i64 %a, i64 %b)
